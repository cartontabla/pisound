...
#ifndef dist_h_
#define dist_h_
#ifndef dist_COMMON_INCLUDES_
#define dist_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
#include "fixedpoint.h"
#include "rt_nonfinite.h"
#include "math.h"
#endif                                 /* dist_COMMON_INCLUDES_ */
...
typedef struct {
  lut_ws_sys_dist_T obj;               /* '<Root>/LUT-WS' */
  vcf_sys_dist_T obj_d;                /* '<Root>/VCF' */
  mix_sys_dist_T obj_e;                /* '<Root>/MIX' */
  arf_sys_dist_T obj_m;                /* '<Root>/ARF' */
  env_sys_dist_T obj_n;                /* '<Root>/ENV' */
} DW_dist_T;
...
struct P_dist_T_ {
  ...
  uint8_T Shaper_rt;                   /* Variable: Shaper_rt
                                        ...
                                        */
  real_T ARF_AttackDefault;            /* Expression: 0.010
                                        * Referenced by: '<Root>/ARF'
                                        */
  real_T ARF_ReleaseDefault;           /* Expression: 0.100
                                        * Referenced by: '<Root>/ARF'
                                        */
  real_T ENV_Eps;                      /* Expression: 1e-12
                                        * Referenced by: '<Root>/ENV'
                                        */
  real_T ENV_TauRMS;                   /* Expression: 0.015
                                        * Referenced by: '<Root>/ENV'
                                        */
  real_T LUTWS_AmountDefault;          /* Expression: 12.0
                                        * Referenced by: '<Root>/LUT-WS'
                                        */
  real_T LUTWS_AsymDefault;            /* Expression: 0.0
                                        * Referenced by: '<Root>/LUT-WS'
                                        */
  real_T LUTWS_Cheb3Default;           /* Expression: 1.0
                                        * Referenced by: '<Root>/LUT-WS'
                                        */
  real_T LUTWS_Cheb5Default;           /* Expression: 0.0
                                        * Referenced by: '<Root>/LUT-WS'
                                        */
  real_T LUTWS_XUser[257];             /* Expression: linspace( -1, 1, 257 )
                                        * Referenced by: '<Root>/LUT-WS'
                                        */
  real_T LUTWS_YUser[257];             /* Expression: linspace( -1, 1, 257 )
                                        * Referenced by: '<Root>/LUT-WS'
                                        */
  real_T LUTWS_MUser;                  /* Expression: 257
                                        * Referenced by: '<Root>/LUT-WS'
                                        */
  real_T LUTWS_Eps;                    /* Expression: 1e-12
                                        * Referenced by: '<Root>/LUT-WS'
                                        */
  ...
  real_T Constant12_Value;             /* Expression: 0.707
                                        ...
                                        */
  real_T Constant14_Value;             /* Expression: 0.83
  ...
  uint8_T ENV_ModeDefault;             /* Expression: uint8( 1 )
                                        * Referenced by: '<Root>/ENV'
                                        */
  uint8_T LUTWS_ModeDefault;           /* Expression: uint8( 3 )
                                        * Referenced by: '<Root>/LUT-WS'
                                        */
...
extern P_dist_T dist_P;

/* Block signals (default storage) */
extern B_dist_T dist_B;

/* Block states (default storage) */
extern DW_dist_T dist_DW;

/* Model entry point functions */
extern void dist_initialize(void);
extern void dist_step(void);
extern void dist_terminate(void);

/* Real-time Model object */
extern RT_MODEL_dist_T *const dist_M;
