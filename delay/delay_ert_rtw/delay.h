...
typedef struct {
  vcd_sys_delay_T obj;                 /* '<Root>/MATLAB System' */
} DW_delay_T;
...
struct P_delay_T_ {
  ...
  real_T Time_rt;                      /* Variable: Time_rt
                                        ...
                                        */
  uint8_T Mode_rt;                     /* Variable: Mode_rt
 ...
 *
 */
extern real_T Mix_rt;                  /* Variable: Mix_rt
                                        * Referenced by:
                                        *   '<Root>/Gain4'
                                        *   '<Root>/Gain5'
                                        *   '<Root>/Gain6'
