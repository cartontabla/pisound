...
#ifndef amp_h_
#define amp_h_
#ifndef amp_COMMON_INCLUDES_
#define amp_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
#include "fixedpoint.h"
#include "rt_nonfinite.h"
#include "math.h"
#endif                                 /* amp_COMMON_INCLUDES_ */
...
typedef struct {
  amp_sys_amp_T obj;                   /* '<Root>/MATLAB System' */
} DW_amp_T;
...
extern P_amp_T amp_P;

/* Block signals (default storage) */
extern B_amp_T amp_B;

/* Block states (default storage) */
extern DW_amp_T amp_DW;

/* Model entry point functions */
extern void amp_initialize(void);
extern void amp_step(void);
extern void amp_terminate(void);

/* Real-time Model object */
extern RT_MODEL_amp_T *const amp_M;
