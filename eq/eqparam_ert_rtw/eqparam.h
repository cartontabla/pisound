...
#ifndef eqparam_h_
#define eqparam_h_
#ifndef eqparam_COMMON_INCLUDES_
#define eqparam_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
#include "fixedpoint.h"
#include "rt_nonfinite.h"
#include "math.h"
#endif                                 /* eqparam_COMMON_INCLUDES_ */

#include "eqparam_types.h"
#include "rtGetNaN.h"
#include "rtGetInf.h"
#include <string.h>
#include <stddef.h>
...
typedef struct {
  ...
  B_MATLABSystem_eqparam_T MATLABSystem5;/* '<Root>/MATLAB System' */
  B_MATLABSystem_eqparam_T MATLABSystem4;/* '<Root>/MATLAB System' */
  B_MATLABSystem_eqparam_T MATLABSystem3;/* '<Root>/MATLAB System' */
  B_MATLABSystem_eqparam_T MATLABSystem2;/* '<Root>/MATLAB System' */
  B_MATLABSystem_eqparam_T MATLABSystem1;/* '<Root>/MATLAB System' */
  B_MATLABSystem_eqparam_T MATLABSystem;/* '<Root>/MATLAB System' */
} B_eqparam_T;

/* Block states (default storage) for system '<Root>' */
typedef struct {
  DW_MATLABSystem_eqparam_T MATLABSystem5;/* '<Root>/MATLAB System' */
  DW_MATLABSystem_eqparam_T MATLABSystem4;/* '<Root>/MATLAB System' */
  DW_MATLABSystem_eqparam_T MATLABSystem3;/* '<Root>/MATLAB System' */
  DW_MATLABSystem_eqparam_T MATLABSystem2;/* '<Root>/MATLAB System' */
  DW_MATLABSystem_eqparam_T MATLABSystem1;/* '<Root>/MATLAB System' */
  DW_MATLABSystem_eqparam_T MATLABSystem;/* '<Root>/MATLAB System' */
} DW_eqparam_T;

/* Parameters (default storage) */
struct P_eqparam_T_ {
  real_T Freq1_rt;                     /* Variable: Freq1_rt
                                        * Referenced by: '<Root>/Constant1'
                                        */
  real_T Freq2_rt;                     /* Variable: Freq2_rt
                                        * Referenced by: '<Root>/Constant2'
                                        */
  real_T Freq3_rt;                     /* Variable: Freq3_rt
                                        * Referenced by: '<Root>/Constant3'
                                        */
  real_T Freq4_rt;                     /* Variable: Freq4_rt
                                        * Referenced by: '<Root>/Constant4'
                                        */
  real_T Freq5_rt;                     /* Variable: Freq5_rt
                                        * Referenced by: '<Root>/Constant5'
                                        */
  real_T Freq6_rt;                     /* Variable: Freq6_rt
  ...
  real_T Gain_rt;                      /* Variable: Gain_rt
                                        ...
                                        */
  real_T Q1_rt;                        /* Variable: Q1_rt
                                        * Referenced by: '<Root>/Constant'
                                        */
  real_T Q2_rt;                        /* Variable: Q2_rt
                                        * Referenced by: '<Root>/Constant17'
                                        */
  real_T Q3_rt;                        /* Variable: Q3_rt
                                        * Referenced by: '<Root>/Constant18'
                                        */
  real_T Q4_rt;                        /* Variable: Q4_rt
                                        * Referenced by: '<Root>/Constant19'
                                        */
  real_T Q5_rt;                        /* Variable: Q5_rt
                                        * Referenced by: '<Root>/Constant20'
                                        */
  real_T Q6_rt;                        /* Variable: Q6_rt
...
extern P_eqparam_T eqparam_P;

/* Block signals (default storage) */
extern B_eqparam_T eqparam_B;

/* Block states (default storage) */
extern DW_eqparam_T eqparam_DW;

/* Model entry point functions */
extern void eqparam_initialize(void);
extern void eqparam_step(void);
extern void eqparam_terminate(void);

/* Real-time Model object */
extern RT_MODEL_eqparam_T *const eqparam_M;
