...
#ifndef rmod_h_
#define rmod_h_
#ifndef rmod_COMMON_INCLUDES_
#define rmod_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
#include "fixedpoint.h"
#include "rt_nonfinite.h"
#include "math.h"
#endif                                 /* rmod_COMMON_INCLUDES_ */
...
typedef struct {
  vco_sys_rmod_T obj;                  /* '<Root>/VCO' */
  mix_sys_rmod_T obj_a;                /* '<Root>/MIX' */
} DW_rmod_T;
...
struct P_rmod_T_ {
  ...
  real_T MIX_SmoothTime;               /* Expression: 0.01
                                        ...
                                        */
  real_T ControlInput_P1_Size[2];    /* Computed Parameter: ControlInput_P1_Size
                                      * Referenced by: '<Root>/Control Input'
                                      */
  real_T ControlInput_P1;              /* Expression: 48000
                                        * Referenced by: '<Root>/Control Input'
                                        */
  real_T ControlInput_P2_Size[2];    /* Computed Parameter: ControlInput_P2_Size
                                      * Referenced by: '<Root>/Control Input'
                                      */
  real_T ControlInput_P2;              /* Expression: 128
                                        * Referenced by: '<Root>/Control Input'
                                        */
  real_T ControlInput_P3_Size[2];    /* Computed Parameter: ControlInput_P3_Size
                                      * Referenced by: '<Root>/Control Input'
                                      */
  real_T ControlInput_P3;              /* Expression: 4
                                        * Referenced by: '<Root>/Control Input'
                                        */
...
extern P_rmod_T rmod_P;

/* Block signals (default storage) */
extern B_rmod_T rmod_B;

/* Block states (default storage) */
extern DW_rmod_T rmod_DW;

/* Model entry point functions */
extern void rmod_initialize(void);
extern void rmod_step(void);
extern void rmod_terminate(void);

/* Real-time Model object */
extern RT_MODEL_rmod_T *const rmod_M;
