...
#ifndef wah_h_
#define wah_h_
#ifndef wah_COMMON_INCLUDES_
#define wah_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
#include "fixedpoint.h"
#include "rt_nonfinite.h"
#include "math.h"
#endif                                 /* wah_COMMON_INCLUDES_ */
...
typedef struct {
  vco_sys_wah_T obj;                   /* '<Root>/MATLAB System1' */
  vcf_sys_wah_T obj_i;                 /* '<Root>/MATLAB System' */
} DW_wah_T;
...
struct P_wah_T_ {
  real_T Depth_rt;                     /* Variable: Depth_rt
                                        ...
                                        */
  real_T FilterGain_rt;                /* Variable: FilterGain_rt
                                        * Referenced by: '<Root>/Constant3'
                                        */
  real_T Fmax_rt;                      /* Variable: Fmax_rt
                                        * Referenced by: '<Root>/Constant5'
                                        */
  real_T Fmin_rt;                      /* Variable: Fmin_rt
                                        * Referenced by: '<Root>/Constant4'
                                        */
  real_T Gain_rt;                      /* Variable: Gain_rt
                                        * Referenced by: '<Root>/Constant7'
                                        */
  real_T Q_rt;                         /* Variable: Q_rt
  ...
  real_T iPhase_rt;                    /* Variable: iPhase_rt
                                        ...
                                        */
  uint8_T Type_rt;                     /* Variable: Type_rt
...
extern P_wah_T wah_P;

/* Block signals (default storage) */
extern B_wah_T wah_B;

/* Block states (default storage) */
extern DW_wah_T wah_DW;

/* Model entry point functions */
extern void wah_initialize(void);
extern void wah_step(void);
extern void wah_terminate(void);

/* Real-time Model object */
extern RT_MODEL_wah_T *const wah_M;
